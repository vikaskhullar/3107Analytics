...
customer_data = customer_data.drop(['customerID', 'genre'], axis=1)
...
pred = cluster.fit_predict(customer_data)

customer_data['labels'] = pred
customer_data

customer_data.to_csv("income.csv")
